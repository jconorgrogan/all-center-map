...
# Validate Comparator's sandbox flags and preserve one outer command separator.
# The pinned Comparator supplies that separator itself. Legacy unseparated
# command vectors are normalized to the same Landrun argument vector.
