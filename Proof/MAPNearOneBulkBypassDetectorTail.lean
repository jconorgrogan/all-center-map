...
namespace MAPNearOneBulkBypassDetectorTail
...
theorem detectorCommonCoefficientMass_le_time_power
    ...
    (hsigmaHigh : sigma ≤ 1) (he : 0 < e) (hK : 0 < K)
    (hdiv : ∀ n : ℕ, 0 < n →
...
end MAPNearOneBulkBypassDetectorTail

#print axioms MAPNearOneBulkBypassDetectorTail.detectorCommonCoefficientMass_le_time_power
#print axioms MAPNearOneBulkBypassDetectorTail.inv_pow_power_radius
#print axioms MAPNearOneBulkBypassDetectorTail.eventually_detectorCommonCoefficient_mul_fourierTail_le
#print axioms MAPNearOneBulkBypassDetectorTail.exists_fourierMoment_gap
#print axioms MAPNearOneBulkBypassDetectorTail.eventually_exists_fourierMoment_detectorCommonCoefficient_mul_fourierTail_le_value
#print axioms MAPNearOneBulkBypassDetectorTail.eventually_exists_fourierMoment_detectorCommonCoefficient_mul_fourierTail_le_inputLoss
