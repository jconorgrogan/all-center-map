...
namespace MAPPrincipalKoukLocalAppendixBFormula
...
theorem exists_eventually_principal_local_formula_of_appendixB
    (hKhale104 : AppendixBCorollary104) (D : ℕ) :
    ∃ c : ℝ, 0 < c ∧
      ∀ᶠ X : ℝ in atTop,
        ∀ t : ℝ, t ∈ Set.Icc X (2 * X) →
...
end MAPPrincipalKoukLocalAppendixBFormula

#print axioms MAPPrincipalKoukLocalAppendixBFormula.exists_eventually_principal_local_formula_of_appendixB
